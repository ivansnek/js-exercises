module.exports = [
  { names: 'Juan Antonio', lastnames: 'ly', birthdate: new Date(1979, 12, 1), type: 'fisica' },
  { names: 'Juan Antonio', lastnames: 'Fernandez Morales', birthdate: new Date(1979, 12, 1), type: 'fisica' },
  { names: 'Aose Carlos', lastnames: 'Carnandez Cerez', birthdate: new Date(1979, 12, 1), type: 'fisica' },
  { names: 'Orenda Liliana', lastnames: 'Petierrez Delasco', birthdate: new Date(1979, 12, 1), type: 'fisica' },
